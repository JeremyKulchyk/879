...
features_1 = ['x1','x2', 'x3','x4']
features_2 = ['y1', 'y2', 'y3', 'y4']
features_3 = ['z1', 'z2', 'z3', 'z4']
...
print(train_X.shape)
train_X = train_X.reshape(-1, 4,100, 1)
#print(train_X.shape)
...
CNN1 = Sequential()
CNN1.add(Conv2D(32, kernel_size=(3, 3),activation='linear',input_shape=(4,100,1),padding='same'))
...
CNN2 = Sequential()
CNN2.add(Conv2D(32, kernel_size=(3, 3),activation='linear',input_shape=(4,100,1),padding='same'))
...
CNN3 = Sequential()
CNN3.add(Conv2D(32, kernel_size=(3, 3),activation='linear',input_shape=(4,100,1),padding='same'))
